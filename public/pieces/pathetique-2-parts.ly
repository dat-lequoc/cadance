...
\score {
 <<
  \new Staff = "melody" { \set Staff.midiInstrument = #"acoustic grand" \topmain }
  \new Staff = "harmony" { \set Staff.midiInstrument = #"acoustic grand" \topsecondary }
  \new Staff = "bass" { \set Staff.midiInstrument = #"acoustic grand" \bottom }
 >>
