...
Alignment is **bar precision only**, from actual MIDI tempo-map ticks and reviewed PDF barlines. No guessed equal-time note sweep or unverified note anchors. The long 24-note coda figure remains across bars 137–139. Plan has 252 validated quests: RH → LH → both where nonempty, ten total runs; cumulative reviews five runs, bounded to at most eight bars. Two-bar rotations and answers are practice cuts, not a claim that every pair is a complete musical phrase.
